...
async function serveStatic(urlPath, res) {
  const file =
    urlPath === "/" || urlPath === "/sideshot" || urlPath === "/index.html"
      ? path.join(root, "sideshot-site", "index.html")
      : path.join(root, "sideshot-site", path.normalize(urlPath).replace(/^\/+/, ""));

  if (!file.startsWith(path.join(root, "sideshot-site"))) {
